 ...
 */
export default function Benifit_Card({ title, frequency, imgLink, placeImg = "bottom", features = [] }) {
  if (placeImg == "bottom") {
    return (
      <div className="benefits-cart-inner-container">
        <div className="benefit_card benefit-card">
          ...
          <div className="benefits_animation-container benefit-card--bottom">
  ...
  else if (placeImg == "right-middle") {
    return (
      <div className="benefits-cart-inner-container">
        <div className="benefit_card benefit-card benefit-card--right-middle">
          <div className="benefit-cart-top-elements">
            <h4 className="benefit-card-max-element">{title}</h4>
            {frequency && <h6>{frequency}</h6>}
          </div>
          <div className="benefits_animation-container">
            <LottiePlayer src={imgLink} />
          </div>
        </div>
      </div>
    ...
    return (
      <div className="benefits-cart-inner-container">
        <div className="benefit_card benefit-card">
          ...
          <div className="benefits_animation-container benefit-card--right-float">
            <LottiePlayer src={imgLink} />
          </div>
        </div>
      </div>
  ...
  else if (placeImg == "right-corner")
    {
    return (
      <div className="benefits-cart-inner-container">
        <div className="benefit_card benefit-card benefit-card--right-corner">
          <div>
            <div className="benefit-cart-top-elements">
              <h4 className="benefit-card-max-element">{title}</h4>
              {frequency && <h6>{frequency}</h6>}
